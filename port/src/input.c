...
void inputSetDefaultKeyBinds(s32 cidx, s32 n64mode)
{
	...
	static const u32 pcjoybinds[][3] = {
		{ CK_A,      SDL_CONTROLLER_BUTTON_B,                0                                            }, // swapped from _A (Switch A/B layout fix)
		{ CK_X,      SDL_CONTROLLER_BUTTON_Y,                0                                            }, // swapped from _X (Switch X/Y layout fix)
		...
		{ CK_DPAD_D, SDL_CONTROLLER_BUTTON_DPAD_UP,          0                                            },
		{ CK_LTRIG,  SDL_CONTROLLER_BUTTON_X,                SDL_CONTROLLER_BUTTON_RIGHTSTICK             },
		{ CK_RTRIG,  VK_JOY1_LTRIG - VK_JOY1_BEGIN,          0                                            },
		{ CK_ZTRIG,  VK_JOY1_RTRIG - VK_JOY1_BEGIN,          0                                            },
		{ CK_START,  SDL_CONTROLLER_BUTTON_START,            0                                            },
		{ CK_C_D,    0,                                      0                                            },
		{ CK_C_U,    0,                                      0                                            },
		{ CK_C_R,    0,                                      0                                            },
		{ CK_C_L,    0,                                      0                                            },
		{ CK_ACCEPT, SDL_CONTROLLER_BUTTON_B,                0                                            }, // swapped from _A (Switch A/B layout fix)
		{ CK_CANCEL, SDL_CONTROLLER_BUTTON_A,                0                                            }, // swapped from _B (Switch A/B layout fix)
		{ CK_B,      SDL_CONTROLLER_BUTTON_A,                0                                            }, // same physical button as CK_CANCEL; some menus check B_BUTTON instead of BUTTON_UI_CANCEL
	...
	static const u32 n64joybinds[][3] = {
		{ CK_A,      SDL_CONTROLLER_BUTTON_B,              0 }, // swapped from _A (Switch A/B layout fix)
		{ CK_B,      SDL_CONTROLLER_BUTTON_A,              0 }, // swapped from _B (Switch A/B layout fix)
		{ CK_LTRIG,  SDL_CONTROLLER_BUTTON_LEFTSHOULDER,   0 },
		{ CK_RTRIG,  SDL_CONTROLLER_BUTTON_RIGHTSHOULDER,  0 },
		{ CK_ZTRIG,  VK_JOY1_RTRIG - VK_JOY1_BEGIN,        0 },
		{ CK_START,  SDL_CONTROLLER_BUTTON_START,          0 },
		{ CK_DPAD_D, SDL_CONTROLLER_BUTTON_DPAD_DOWN,      0 },
		{ CK_DPAD_U, SDL_CONTROLLER_BUTTON_DPAD_UP,        0 },
		{ CK_DPAD_L, SDL_CONTROLLER_BUTTON_DPAD_LEFT,      0 },
		{ CK_DPAD_R, SDL_CONTROLLER_BUTTON_DPAD_RIGHT,     0 },
	};

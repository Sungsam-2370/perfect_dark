...
void inputSetDefaultKeyBinds(s32 cidx, s32 n64mode)
{
	...
	static const u32 pcjoybinds[][2] = {
		{ CK_A,      SDL_CONTROLLER_BUTTON_B                                                              }, // swapped from _A (Switch A/B layout fix)
		{ CK_X,      SDL_CONTROLLER_BUTTON_Y                                                              }, // swapped from _X (Switch X/Y layout fix)
		...
		{ CK_DPAD_D, SDL_CONTROLLER_BUTTON_DPAD_UP                                                        },
		...
		{ CK_C_R,    0                                                                                    },
		{ CK_C_L,    0                                                                                    },
		{ CK_ACCEPT, SDL_CONTROLLER_BUTTON_B                                                              }, // swapped from _A (Switch A/B layout fix)
		{ CK_CANCEL, SDL_CONTROLLER_BUTTON_A                                                              }, // swapped from _B (Switch A/B layout fix)
	...
	static const u32 n64joybinds[][2] = {
		{ CK_A,      SDL_CONTROLLER_BUTTON_B             }, // swapped from _A (Switch A/B layout fix)
		{ CK_B,      SDL_CONTROLLER_BUTTON_A             }, // swapped from _B (Switch A/B layout fix)
